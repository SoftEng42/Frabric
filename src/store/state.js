...
const getters = {
  ...
  govID(state) {
    return state.submissions.owner.govID.documents
  },

  legal(state) {
    return state.submissions.ownership.legal.documents
  },
...
const actions = {
  async sign(context, param) {
    context.commit('sign', param)
  },
  ...
  async setSubmissions(context, param) {
    context.commit('setSubmission', param)
  },

  async setProperty(context, param) {
    context.commit('setProperty', param)
  },

  async setGovIDDocuments(context, param) {
    context.commit('setGovID', param)
  },

  async setLegalDocuments(context, param) {
    context.commit('setLegal', param)
  },
...
const mutations = {
  ...
  setProperty(state, property) {
    state.submissions.property = property.property
    state.submissions.ethAddress = property.ethAddress
  },

  setGovID(state, filePaths) {
    state.submissions.owner.govID.documents = filePaths
  },

  setLegal(state, filePaths) {
    state.submissions.ownership.legal.documents = filePaths
  },
